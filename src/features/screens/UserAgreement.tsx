...
type UserAgreementScreenNavigationProp = NativeStackNavigationProp<
  RootStackParamsList,
  "UserAgreement"
>;
type Props = {
...
const UserAgreement: FC<Props> = ({navigation}) => {
  const insets = useSafeAreaInsets();
  return (
    <View style={[styles.container, {paddingTop: insets.top}]}>
      <View>
        <CustomHeader title='User Agreement' backIcon={true} backgroundColor='#2a2a2a' gap={hs(80)} onPress={() => navigation.goBack()}/>
      </View>
